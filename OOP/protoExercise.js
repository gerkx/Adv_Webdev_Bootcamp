...
/* 2 - Add a function on the Person.prototype called fullName that returns the firstName and lastName property of an object created by 
the Person constructor concatenated together.
...
// This will involve you going back and adding an additional line of code to your Person constructor you previously created in exercise 1.
...
Person.prototype.addToFamily = function(newFamily){ 
    if(this.family.indexOf(newFamily) === -1 && newFamily instanceof Person){
...
// 1 - Implement your own version of Array.prototype.map. The function should accept a callback and return a new array 
// with the result of the callback for each value in the array.
